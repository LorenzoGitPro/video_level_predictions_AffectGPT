...
def run():
    ...
    parser = argparse.ArgumentParser(description="Evaluate the performance of a binary model")
    parser.add_argument("--gt", required=True, help="Path to the ground truth labels .npy file")
    parser.add_argument("--pred", required=True, help="Path to the binary predictions .npy file")
