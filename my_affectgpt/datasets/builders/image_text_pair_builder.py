...
from my_affectgpt.datasets.datasets.bah import BAH_Dataset

@registry.register_builder("bah")  
class BAHBuilder(BaseDatasetBuilder):
    train_dataset_cls = BAH_Dataset

    def build_datasets(self):
        logging.info("Building datasets BAH")
        self.build_processors()
